...
let positif = ['a+','acungan jempol','adaptif','adil','afinitas','afirmasi','agilely','agung','ahli','ahlinya','ajaib','aklamasi',
	'akomodatif','akurat','alam mimpi','alhamdulillah','allahu akbar','altruistis','aman','amanah','amat','ambisius','andal',
	...
	'fasih','fav','fave','favorit','fenomenal','firdaus','fleksibel','fleksibilitas','futuristik','gagah','gaib','gainfully',
	...
	'mulia','mulus','murah','murah banget','murah hati','murni','mutakhir','nasib','nikmat','non-kekerasan','nyaman','nyaring',
	...
	'penuh kepercayaan','penuh pengharapan','penuh perasaan','penuh perhatian','penuh peristiwa','penuh semangat','penuh sukacita',
	...
	'sah','saleh','salut','sangat','sangat baik','sangat berharga','sangat indah','sangat memuaskan','sangat menarik',
	...
	'sehat','seimbang','seksi','selamat','selamat','selayaknya','selektif','semakin lembut','semakin makmur','semangat',
	...
	'uye','variasi','visioner','wah','wahyu','warna-warni','waspada','whooa','whooooa','wow','wow','yakin','yay','yeah','yihaa'];
let negatif = ['abnormal','absurd','acak','acak-acakan','acuh','acuh tak acuh','adiktif','adil','agresi','agresif','agresor',
	...
	'asem','asing','astaghfirullah','asusila','awan','awas','babi','badai','bahan tertawaan','bahaya','bajingan','baju kotor',
	'balas dendam','bandel','bandot','bangkrut','bantingan','banyak sekali','barang ganjil','barbar','basi','bau','bawahan',
	...
	'cabul','cacat','cacian','calo','cambuk','canggung','cara','cari perkara','carut-marut','cebol','cedera','cekcok',
	...
	'jalan keluar','jancuk','janggal','jatuh','jatuh sakit','jauh','jebakan','jelaga','jelas','jelatang','jelek','jelu',
	...
	'kebungungan','kebiri','kebisingan','kebobolan','kebocoran','kebodohan','kebohongan','kebosanan','kebrutalan','kebuntuan',
	...
	'memadamkan','memakan waktu','memaksa','memaksakan','memalsukan','memalukan','memamerkan','memanaskan','memancing',
	'memandang dengan marah','memandang rendah','memanjakan','memar','memarahi','memarahkan','memarut','mematahkan semangat',
	...
	'merayap','merebut','meremas','meremehkan','merencanakan','merendahkan','merendahkan martabat','merengek','merenung','merepet',
...
let cari = function (docs){
	docs = stopword.stopwords(docs);
    //console.log(docs)
	let docsasarrtostr = docs.toString();
	let docasstr = docsasarrtostr.replace(/,/g, ' ');
    //var docasstr = docsdalamarrtostr.replace(',', ' ');
	let ckwd = [];
	for(let i = 0; i < docs.length; i++){
		if(positif.indexOf(docs[i]) !== -1){
			ckwd.push(docs[i]+ ' ada dikalimat positif');
		}
		if(negatif.indexOf(docs[i]) !== -1){
			ckwd.push(docs[i]+ ' ada dikalimat negatif');
		}
	}
	return {ckdw:ckwd, docs:docasstr};
};
module.exports = {cari};
//console.log(cari('      kan sg jg gak mati2an gmna u/ first moviex gk kek si ono yg rela rasain k…  ').ckdw);
